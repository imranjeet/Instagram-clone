...
class Reactions with ChangeNotifier {
  ...
  List<Reaction> reactionfindByuserId(int videoId, String userId) {
    return _items
        .where((reaction) =>
  ...
  List<Reaction> reactionByUserId(String userId) {
    return _items.where((reaction) => reaction.userId == userId).toList();
  }
