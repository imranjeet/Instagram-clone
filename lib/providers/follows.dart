...
class Follows with ChangeNotifier {
  ...
  List<Follow> followersByUserId(String userId) {
    return _items.where((fol) => fol.followUserId == userId).toList();
  }

  List<Follow> followingsByUserId(String userId) {
    return _items.where((follower) => follower.userId == userId).toList();
  }

  List<Follow> followFindByUserId(String userId, String followUserId) {
    return _items
        .where((follow) =>
  ...
  Future<void> addFollow(String userId, String followUserId) async {
